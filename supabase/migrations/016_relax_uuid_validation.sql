-- Migration 016: Relax UUID validation for methodId to support test data
-- This allows non-standard UUIDs like 00000000-0000-0000-0000-000000000005

SET search_path TO public;

-- Drop and recreate the function with relaxed type casting
...
BEGIN
    ...
    -- Changed: Cast methodId as TEXT first, then to UUID to allow non-standard UUIDs
    WITH inserted AS (
