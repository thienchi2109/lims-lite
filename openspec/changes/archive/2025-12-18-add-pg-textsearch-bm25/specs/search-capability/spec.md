...
Provide BM25-ranked full-text search across CDC-LIMS entities (samples, clients, assays, results, audit logs) using the pg_textsearch PostgreSQL extension, with RLS-compliant result filtering and role-based access control.
