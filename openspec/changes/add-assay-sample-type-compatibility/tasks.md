...
- [x] 4.4 Sau merge/push, không apply lại 204-208; apply chỉ migration 209 forward-only trên home server, deploy manager app và chạy `run_security_tests()` cùng smoke manager workspace.
