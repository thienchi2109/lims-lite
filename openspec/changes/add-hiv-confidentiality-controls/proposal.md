...
- **Workflow and surface consistency:**
  ...
  - Require confidential authorization for manager approval of confidential results and hide confidential items from unauthorized approval workspace tabs, including pending and approved-result views.
...
- Managers without confidential authorization will not see confidential items in approval workspace tabs and will not be able to approve confidential results.
