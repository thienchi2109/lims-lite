# coa-pdf-download Specification

## Purpose
Defines the authorization, integrity, conversion, rate-limit, audit, and
deployment requirements for downloading transient PDFs from released CoA HTML
artifacts.
