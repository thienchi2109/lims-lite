...
import OtpStepUpPage from './page'

describe('OtpStepUpPage', () => {
    beforeEach(() => {
        vi.clearAllMocks()
    ...
    it('supports confidential analysts through the canonical shared OTP route', async () => {
