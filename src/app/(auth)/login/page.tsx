...
import { Lock, User, Loader2, AlertCircle, Eye, EyeOff, Phone, ShieldCheck } from 'lucide-react'
                ...
                <div className="w-full max-w-[400px] space-y-8 animate-in slide-in-from-right-8 duration-700">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex w-full flex-col items-center gap-4">
                            ...
                            <div className="w-full rounded-2xl border border-slate-200/80 bg-gradient-to-br from-slate-50 to-white p-4 shadow-sm shadow-slate-200/40 dark:border-slate-800 dark:from-slate-900 dark:to-slate-900/80 dark:shadow-none">
                                <div className="flex items-center gap-3 border-b border-slate-200/70 pb-3 dark:border-slate-800">
                                    <div className="rounded-full bg-blue-100 p-2 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
                                        <ShieldCheck className="h-4 w-4" />
                                    </div>
                                    <div>
                                        <h4 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Hỗ trợ kỹ thuật</h4>
                                        <p className="text-xs text-slate-500 dark:text-slate-400">Liên hệ quản trị hệ thống khi cần trợ giúp đăng nhập</p>
                                    </div>
                                </div>
                                <div className="mt-3 space-y-3">
                                    <div>
                                        <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">Nguyễn Thiện Chí</p>
                                        <p className="text-xs text-slate-500 dark:text-slate-400">Phát triển và quản trị hệ thống</p>
                                    </div>
                                    <a
                                        href="tel:0907984746"
                                        className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-700 transition-colors hover:border-blue-200 hover:text-blue-700 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:border-blue-900 dark:hover:text-blue-300"
                                    >
                                        <span className="flex items-center gap-2">
                                            <Phone className="h-4 w-4 text-blue-500" />
                                            090 798 4746
                                        </span>
                                        <span className="text-xs font-medium text-slate-500 dark:text-slate-400">Gọi ngay</span>
                                    </a>
                                </div>
                            </div>
                        </div>
