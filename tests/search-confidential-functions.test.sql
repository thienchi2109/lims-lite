...
BEGIN
    ...
    VALUES
        ('85555555-5555-5555-5555-555555555555', 'B5-GLOBAL-MIXED-CONF', '83333333-3333-3333-3333-333333333333', 'B5 GLOBAL MIXED CONFIDENTIAL', 'received', '82222222-2222-2222-2222-222222222222', 'Máu', TRUE),
        ('86666666-6666-6666-6666-666666666666', 'B5-GLOBAL-MIXED-PUBLIC', '84444444-4444-4444-4444-444444444444', 'B5 GLOBAL MIXED PUBLIC', 'received', '82222222-2222-2222-2222-222222222222', 'Máu', TRUE)
    ON CONFLICT (id) DO UPDATE
    SET
